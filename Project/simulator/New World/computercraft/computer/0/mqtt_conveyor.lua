...
local topic_requests = "conveyor_request"
local topic_responses = "conveyor_response"
...
-- quick and dirty dump for tables
...
client:on {
    ...
    message = function(msg)
        ...
        if msgPayload ~= "done" then
            ...
            controller.controller(msgPayload)
